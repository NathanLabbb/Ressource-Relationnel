...
<div class="navbar-menu relative z-50 hidden">
  ...
  <nav class="flex absolute left-1/4" aria-label="Breadcrumb">
  ...
  data() {
    return {
      infos: [
        ...
        { idCategory: 'test 2', info: [{"name":"Jean", "CategoryName": "test 1"}]},
        { idCategory: 'test 3', info: [{"name":"Jean", "CategoryName": "test 1"}]},
        { idCategory: 'test 4', info: [{"name":"Jean", "CategoryName": "test 1"}]},
      ]
    };
  },
  computed: {
